...
public class AuthController {
    ...
    public void getUser(@RequestParam("code") String code) {
        ...
        try {
            ...
            list.add(new BasicNameValuePair("client_id", "3efed1b571d5fa2b9a3d"));
            list.add(new BasicNameValuePair("client_secret", "295000b586faacdf26d9f4b781b90ae62bd580b3"));
            ...
            response.sendRedirect("http://localhost:8088/#/home/dashboard?uId=" + JSONObject.parseObject(user).getString("id"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
